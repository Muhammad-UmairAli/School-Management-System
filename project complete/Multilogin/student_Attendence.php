...
<table class="table table-bordered  table-dark  table-hover table-striped">
    ...
    $result = mysqli_query($con, "SELECT * FROM attendence WHERE registration_id = '$id'");

    while ($test = mysqli_fetch_array($result)) {
        $no = $test['no'];
        echo "<tr align='center'>";
        echo "<td><font color='white'>" . $test['registration_id'] . "</font></td>";
        echo "<td><font color='white'>" . $test['Lecturename'] . "</font></td>";
        echo "<td><font color='white'>" . $test['Lecturedate'] . "</font></td>";
        echo "<td><font color='white'>" . $test['Starttime'] . "</font></td>";
        echo "<td><font color='white'>" . $test['endtime'] . "</font></td>";
        echo "</tr>";
    }
    ?>
