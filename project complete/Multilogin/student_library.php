...
<table class="table table-bordered table-dark  table-hover table-striped">
    ...
    $result = mysqli_query($con, "SELECT * FROM library WHERE registration_id = '$id'");

    while ($test = mysqli_fetch_array($result)) {
        $no = $test['no'];
        echo "<tr align='center'>";
        echo "<td><font color='white'>" . $test['registration_id'] . "</font></td>";
        echo "<td><font color='white'>" . $test['BookISBN'] . "</font></td>";
        echo "<td><font color='white'>" . $test['BookName'] . "</font></td>";
        echo "<td><font color='white'>" . $test['BorrowDate'] . "</font></td>";
        echo "<td><font color='white'>" . $test['ReturnDate'] . "</font></td>";
        echo "</tr>";
    }
    ?>
