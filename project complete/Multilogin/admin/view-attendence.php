...
<table class="table table-bordered   table-hover table-striped">
    ...
    while ($test = mysqli_fetch_array($result)) {
        ...
        echo "<td><font color='black'>" . $test['Lecturename'] . "</font></td>";
        echo "<td><font color='black'>" . $test['Lecturedate'] . "</font></td>";
        echo "<td><font color='black'>" . $test['Starttime'] . "</font></td>";
        echo "<td><font color='black'>" . $test['endtime'] . "</font></td>";
        echo "<td> <a href ='edit-attendence.php?no=$no'><button class='btn btn-success fas fa-edit'>Edit</button></a></td>";
        echo "<td> <a href ='delete-attendence.php?no=$no'>
