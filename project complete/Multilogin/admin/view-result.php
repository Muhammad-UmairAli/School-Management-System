...
<table class="table table-bordered   table-hover table-striped">
    ...
    while ($test = mysqli_fetch_array($result)) {
        ...
        echo "<td><font color='black'>" . $test['std_name'] . "</font></td>";
        echo "<td><font color='black'>" . $test['sub_name'] . "</font></td>";
        echo "<td><font color='black'>" . $test['marks'] . "</font></td>";
        echo "<td><font color='black'>" . $test['obtainedmarks'] . "</font></td>";
        echo "<td><font color='black'>" . $test['percentages'] . "</font></td>";

        echo "<td> <a href ='edit-result.php?no=$no'><button class='btn btn-success fas fa-edit'>Edit</button></a></td>";
        echo "<td> <a href ='delete-result.php?no=$no'>
