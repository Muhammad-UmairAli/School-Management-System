        ...
        <div class="row ">
            ...
            <div class="col-sm-4">
                <div class=" card mt-1 loginbox ">
                    <div class="card-header text-dark ">STUDENT Record</div>
                    <div class="card-body">
                        <form class="text-white" action="" method="POST">
                            <div class="form-group">
                                <label for="name" class="text-dark">Student Name</label>
                                <input class="form-control text-dark" type="text" id="name" placeholder="Enter Student Name" name="name" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
                                ...
                                <input class="form-control text-dark" type="text" id="name" placeholder="Enter Email" name="email" required>
							</div>
							<div class="form-group">
                                <label for="name" class="text-dark">Student Address</label>
                                <input class="form-control text-dark" type="text"  placeholder="Enter Address" name="address" required>
                            </div>
                            <div class="form-group">
...
if (isset($_POST['enter'])) {
    ...
    $sql = "INSERT INTO record (name,registration_id,email,address) VALUES ('$name','$id','$email','$address')";
