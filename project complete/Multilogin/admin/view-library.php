...
<table class="table table-bordered   table-hover table-striped">
    ...
    while ($test = mysqli_fetch_array($result)) {
        ...
        echo "<td><font color='black'>" . $test['BookISBN'] . "</font></td>";
        echo "<td><font color='black'>" . $test['BookName'] . "</font></td>";
        echo "<td><font color='black'>" . $test['BorrowDate'] . "</font></td>";
        echo "<td><font color='black'>" . $test['ReturnDate'] . "</font></td>";
        echo "<td> <a href ='edit-library.php?no=$no'><button class='btn btn-success fas fa-edit'>Edit</button></a></td>";
        echo "<td> <a href ='delete-library.php?no=$no'>
