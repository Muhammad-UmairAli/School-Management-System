...
<table class="table table-bordered   table-hover table-striped">
    ...
    while ($test = mysqli_fetch_array($result)) {
        ...
        echo "<td><font color='black'>" . $test['submission'] . "</font></td>";
        echo "<td> <a href ='edit-fee.php?no=$no'><button class='btn btn-success fas fa-edit'>Edit</button></a></td>";
        echo "<td> <a href ='delete-fee.php?no=$no'>
